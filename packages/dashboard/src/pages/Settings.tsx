                    ...
                    <div className="card">
                        ...
                        <div className="space-y-6">
                            <div>
                                ...
                                <div className="flex gap-3">
                                    <input
                                        ...
                                        defaultValue="************************"
                                    />
                                    <button className="px-4 py-2 bg-surfaceHighlight hover:bg-border text-white rounded-lg font-medium transition-colors border border-border">
                                        Update
                                    </button>
                                </div>
                                <p className="text-xs text-textMuted mt-2">Set via environment variable \`OPENAI_API_KEY\`.</p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="text-xs text-textMuted mt-2">Set via environment variable \`ANTHROPIC_API_KEY\`.</p>
                            </div>

                            <div className="pt-6 mt-6 border-t border-border">
                                <button className="flex items-center gap-2 px-5 py-2.5 bg-primary hover:bg-primary/90 text-white rounded-lg font-medium transition-colors ml-auto">
