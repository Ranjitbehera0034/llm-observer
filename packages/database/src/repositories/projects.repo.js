...
const createProject = (project) => {
  ...
  `);
    stmt.run(id, project.name, apiKey, project.daily_budget || null, project.weekly_budget || null, project.monthly_budget || null, project.alert_threshold ?? 0.8, project.kill_switch === false ? 0 : 1, project.webhook_url || null);
    return id;
};
