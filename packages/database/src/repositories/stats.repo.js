...
exports.getPromptCacheSuggestions = exports.getCostOptimizationSuggestions = exports.getStatsByProvider = void 0;
const db_1 = require("../db");
const getStatsByProvider = (projectId = 'default', days = 30) => {
...
exports.getStatsByProvider = getStatsByProvider;
const getCostOptimizationSuggestions = (projectId = 'default') => {
    const db = (0, db_1.getDb)();
    const suggestions = [];
    ...
    `);
    const smallPayloads = smallPayloadsStmt.all(projectId);
...
exports.getCostOptimizationSuggestions = getCostOptimizationSuggestions;
const getPromptCacheSuggestions = (projectId = 'default') => {
    const db = (0, db_1.getDb)();
    const stmt = db.prepare(`
        SELECT
            prompt_hash,
        ...
        LIMIT 10
    `);
    const duplications = stmt.all(projectId);
...
exports.getPromptCacheSuggestions = getPromptCacheSuggestions;
